  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 mb-8">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{status}</p>
        <div className="w-80 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden shadow-inner">
